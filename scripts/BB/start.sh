...
echo ""
echo bin/bb-server2 -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=$JMX_PORT -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -J-Xloggc:$LOG_DIR/jvm.log -J-XX:+HeapDumpOnOutOfMemoryError -J-XX:+DisableExplicitGC -J-XX:+PrintGCDetails -J-XX:+PrintGCDateStamps -J-Xmx768m -J-XX:MaxPermSize=128m -Dhttp.port=9001 -Dconfig.file=/opt/conf/bb_prod.conf
echo ""
