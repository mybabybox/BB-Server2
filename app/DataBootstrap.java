...
public class DataBootstrap {
    ...
    private static void bootstrapCountry() {
        ...
        country = new Country("海外", CountryCode.INTL, "/assets/app/images/country/intl.png");
        country.save();
        country = new Country("香港", CountryCode.HK, "/assets/app/images/country/hk.png");
        country.save();
        country = new Country("美國", CountryCode.US, "/assets/app/images/country/us.png");
        country.save();
        country = new Country("日本", CountryCode.JP, "/assets/app/images/country/jp.png");
        country.save();
        country = new Country("韓國", CountryCode.KR, "/assets/app/images/country/kr.png");
        country.save();
        country = new Country("台灣", CountryCode.TW, "/assets/app/images/country/tw.png");
        country.save();
        country = new Country("泰國", CountryCode.TH, "/assets/app/images/country/th.png");
        country.save();
        country = new Country("馬來西亞", CountryCode.MY, "/assets/app/images/country/my.png");
        country.save();
        country = new Country("印尼", CountryCode.ID, "/assets/app/images/country/id.png");
        country.save();
        country = new Country("澳洲", CountryCode.AU, "/assets/app/images/country/au.png");
        country.save();
        country = new Country("紐西蘭", CountryCode.NZ, "/assets/app/images/country/nz.png");
        country.save();
        country = new Country("德國", CountryCode.DE, "/assets/app/images/country/de.png");
        country.save();
        country = new Country("英國", CountryCode.GB, "/assets/app/images/country/gb.png");
        country.save();
        country = new Country("意大利", CountryCode.IT, "/assets/app/images/country/it.png");
        country.save();
        country = new Country("法國", CountryCode.FR, "/assets/app/images/country/fr.png");
        country.save();
        country = new Country("西班牙", CountryCode.ES, "/assets/app/images/country/es.png");
        country.save();
        country = new Country("荷蘭", CountryCode.NL, "/assets/app/images/country/nl.png");
        country.save();
        country = new Country("挪威", CountryCode.NO, "/assets/app/images/country/no.png");
        country.save();
        country = new Country("愛爾蘭", CountryCode.IE, "/assets/app/images/country/ie.png");
        country.save();
        country = new Country("丹麥", CountryCode.DK, "/assets/app/images/country/dk.png");
        country.save();
        country = new Country("瑞典", CountryCode.SE, "/assets/app/images/country/se.png");
        country.save();
        country = new Country("瑞士", CountryCode.CH, "/assets/app/images/country/ch.png");
        country.save();
        country = new Country("冰島", CountryCode.IS, "/assets/app/images/country/is.png");
        country.save();
        country = new Country("加拿大", CountryCode.CA, "/assets/app/images/country/ca.png");
        country.save();
    }
